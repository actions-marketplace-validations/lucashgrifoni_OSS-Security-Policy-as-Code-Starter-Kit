...
| Area | What you get |
|---|---|
| Current public release | `v7.3.0` (PyPI package `oss-policy-kit`) <!-- x-release-please-version --> |
| Runtime | Python 3.12+ |
...
## v7.3.0 baseline <!-- x-release-please-version -->

| Area | v7.3.0 <!-- x-release-please-version --> |
|---|---|
| Profiles | 56 bundled profiles |
| Controls | 220 bundled controls |
| CLI subcommands | 20 |
