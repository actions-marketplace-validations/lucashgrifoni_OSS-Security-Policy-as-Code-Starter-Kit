...
| Area | What you get |
|---|---|
| Current public release | `v7.1.0` (PyPI package `oss-policy-kit`) <!-- x-release-please-version --> |
| Runtime | Python 3.12+ |
...
## v7.1.0 baseline <!-- x-release-please-version -->

| Area | v7.1.0 <!-- x-release-please-version --> |
|---|---|
