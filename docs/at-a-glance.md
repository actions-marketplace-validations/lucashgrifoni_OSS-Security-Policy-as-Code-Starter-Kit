...
| Area | What you get |
|---|---|
| Current public release | `v6.7.0` (PyPI package `oss-policy-kit`) <!-- x-release-please-version --> |
| Runtime | Python 3.12+ |
...
## v6.7.0 baseline <!-- x-release-please-version -->

| Area | v6.7.0 <!-- x-release-please-version --> |
|---|---|
