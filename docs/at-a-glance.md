...
| Area | What you get |
|---|---|
| Current public release | `v10.0.1` (PyPI package `oss-policy-kit`) <!-- x-release-please-version --> |
| Runtime | Python 3.12+ |
...
## v10.0.1 baseline <!-- x-release-please-version -->

| Area | v10.0.1 <!-- x-release-please-version --> |
|---|---|
| Profiles | 56 bundled profiles |
| Controls | 222 bundled controls |
| CLI subcommands | 23 |
| Report contracts | `reports/2.0` only (legacy pre-2.0 contracts removed in v9.0.0, ADR-043) |
